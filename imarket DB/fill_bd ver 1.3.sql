...
values ('admin', '$2a$04$UoIv/26fwNnjmPB0D5JkI.rFkrUxUArF7zXfMz1cs4zEvgXfEBEiO', 'ROLE_ADMIN'); -- password - admin
INSERT INTO users (login, password, role)
values ('user1', '$2a$04$cvLPhDFUMgn7tkkEziFde./hIrax5WQcWWB/Dka.texOAUITKpEwm', 'ROLE_USER'); -- password - user1
INSERT INTO users (login, password, role)
values ('user2', '$2a$04$b1WxKsOUR7WktR0fI8Nnfe269Beuwz43Ja6CbmDvgIGhXYOOT5m0S', 'ROLE_USER'); -- password - user2
INSERT INTO users (login, password, role)
values ('user3', '$2a$04$/FgFUjmQGpideWx6cUrNqOYZc3FhA66VM9XbxJ5SDhajZPva2uLju', 'ROLE_USER'); -- password - user3
INSERT INTO users (login, password, role)
values ('user4', '$2a$04$nf6cUE9VgOoDGneG8H0kKOdz4O.76LNvHz5EWwb8LsQJQLTyJm71K', 'ROLE_USER'); -- password - user4
INSERT INTO users (login, password, role)
values ('user5', '$2a$04$CtTBQZAABC4FpjsHFg5Pdu5GBa4H2XH7HXMlh5nBS0ZFH1Lb9FEA2', 'ROLE_USER');
-- password - user5

-- -----------------------------------------------------
-- fill profiles
-- -----------------------------------------------------
INSERT INTO profiles (user_id, avatar, money_balance, user_rank)
values (1, 'Master of market', 0, 1000); -- 1
INSERT INTO profiles (user_id, money_balance, user_rank)
values (2, 1000, 10); -- 2
INSERT INTO profiles (user_id, money_balance, user_rank)
values (3, 500, 5); -- 3
INSERT INTO profiles (user_id, money_balance, user_rank)
...
-- fill coupons
-- -----------------------------------------------------
INSERT INTO coupons (user_id, discount, coupon_name)
values (2, 50, 'New user');
INSERT INTO coupons (user_id, discount, coupon_name)
values (2, 10, 'Evroopt');
INSERT INTO coupons (user_id, discount, coupon_name)
values (2, 10, 'Belneftehim');
INSERT INTO coupons (user_id, discount, coupon_name)
values (3, 50, 'New user');
INSERT INTO coupons (user_id, discount, coupon_name)
values (4, 50, 'New user');
INSERT INTO coupons (user_id, discount, coupon_name)
values (5, 10, 'Belneftehim');
INSERT INTO coupons (user_id, discount, coupon_name)
values (6, 50, 'New user');
INSERT INTO coupons (user_id, discount, coupon_name)
values (6, 100, 'Lottery');
-- -----------------------------------------------------
-- fill advert_topics
-- -----------------------------------------------------
INSERT INTO advert_topics (topic_name)
values ('Auto'); -- 1
INSERT INTO advert_topics (topic_name)
values ('Real Estate'); -- 2
INSERT INTO advert_topics (topic_name)
values ('Phones'); -- 3
INSERT INTO advert_topics (topic_name)
values ('Appliances'); -- 4
INSERT INTO advert_topics (topic_name)
values ('Electronics'); -- 5
INSERT INTO advert_topics (topic_name, topic_sub_name)
values ('Clothes', 'for men'); -- 6
INSERT INTO advert_topics (topic_name, topic_sub_name)
values ('Clothes', 'for women'); -- 7
INSERT INTO advert_topics (topic_name, topic_sub_name)
values ('Clothes', 'for children'); -- 8
INSERT INTO advert_topics (topic_name)
values ('Pets'); -- 9
INSERT INTO advert_topics (topic_name)
values ('Home'); -- 10
...
-- fill advert_ranks
-- -----------------------------------------------------
INSERT INTO advert_ranks (rank_name, rank_price)
values ('USUAL', 0);
INSERT INTO advert_ranks (rank_name, rank_price)
values ('PRIOR', 5);
INSERT INTO advert_ranks (rank_name, rank_price)
...
INSERT INTO comments (adv_id, user_id, comment_date, comment_text)
values (1, 5, '2020-06-04', 'What is iPhone condition?');
INSERT INTO comments (adv_id, user_id, comment_date, comment_text)
values (1, 4, '2020-06-05', 'What about 80?');
INSERT INTO comments (adv_id, user_id, comment_date, comment_text)
values (1, 2, '2020-06-05', 'Very good condition!');
INSERT INTO comments (adv_id, user_id, comment_date, comment_text)
values (1, 2, '2020-06-06', 'OK, let it be 80.');
-- about adv N 2
INSERT INTO comments (adv_id, user_id, comment_date, comment_text)
...
-- adv N 17 by user N 6
INSERT INTO comments (adv_id, user_id, comment_date, comment_text)
values (1, 5, '2020-06-01', 'What kind of house do you interested in');
INSERT INTO comments (adv_id, user_id, comment_date, comment_text)
values (1, 6, '2020-06-02', '2 bedrooms, big kitchen in the centre of the city');
...
values (4, 2, 2, '2020-06-09', 30, 'RECEIVED', 'Everything OK, good seller');
-- 1
-- about adv N 3; seller N 2,  buyer N 6
INSERT INTO sell_histories (buyer_id, seller_id, adv_id, sell_date, sell_price, sell_status, buyer_review)
values (6, 2, 3, '2020-05-15', 25, 'SEND', 'Don''t receive yet');
-- 2
-- about adv N 10; seller N 4,  buyer N 3
INSERT INTO sell_histories (buyer_id, seller_id, adv_id, sell_date, sell_price, sell_status)
values (3, 4, 10, '2020-05-30', 30, 'PAID');
-- 3 Paid only
-- about adv N 11; seller N 4,  buyer N 2
INSERT INTO sell_histories (buyer_id, seller_id, adv_id, sell_date, sell_price, sell_status, buyer_review)
values (2, 4, 11, '2020-05-28', 50, 'RECEIVED', 'Good Sneakers');
-- 4 received

-- -----------------------------------------------------
-- fill debates
-- -----------------------------------------------------  
-- sell_hist N 1, buyer N 3, seller N 2 
INSERT INTO debates (sell_history_id, user_id, debate_date, debate_text)
values (1, 3, '2020-06-02', 'I already paid for the phone. Did you send it?');
INSERT INTO debates (sell_history_id, user_id, debate_date, debate_text)
values (1, 2, '2020-06-03', 'Yes, sent to days ago');
INSERT INTO debates (sell_history_id, user_id, debate_date, debate_text)
values (1, 3, '2020-06-04', 'Already received. Phone in good condition');
-- about sell_hist N 2; seller N 2,  buyer N 6
INSERT INTO debates (sell_history_id, user_id, debate_date, debate_text)
values (2, 6, '2020-05-17', 'Did you send my fone?');
INSERT INTO debates (sell_history_id, user_id, debate_date, debate_text)
values (2, 2, '2020-05-18', 'Not yet, sorry');
INSERT INTO debates (sell_history_id, user_id, debate_date, debate_text)
values (2, 2, '2020-05-19', 'Already sent');
-- sell_hist N 4, buyer N 4, seller N 2     
INSERT INTO debates (sell_history_id, user_id, debate_date, debate_text)
values (4, 4, '2020-05-29', 'Is it a real leather?');
INSERT INTO debates (sell_history_id, user_id, debate_date, debate_text)
values (4, 2, '2020-05-30', 'Yes of course!');
INSERT INTO debates (sell_history_id, user_id, debate_date, debate_text)
values (4, 4, '2020-05-31', 'Everithing is OK');
